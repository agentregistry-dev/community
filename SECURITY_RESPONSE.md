# agentregistry Security Incident Response Process

This document outlines the process the agentregistry team follows when handling security vulnerabilities reported in our open-source applications and libraries. Our goal is to be transparent with our community about how we triage, fix, and disclose security issues.

This process applies only to the open-source tools maintained by the agentregistry project.
...
1. **Affected Versions**: Identify all previous versions of the agentregistry open-source application that contain the vulnerability.
